...
func _physics_process(delta):
  ...
  # Handle sprint
  speed = (SPRINT_SPEED if Input.is_action_pressed("sprint") else WALK_SPEED) * scale_factor
  ...
  # Handle head bob
  t_bob += delta * velocity.length() * float(is_on_floor()) / scale_factor
